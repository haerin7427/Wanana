        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-custom-font u-nav u-unstyled u-nav-1">
				...
				<li class="u-nav-item">
            		<a class="u-button-style u-nav-link u-text-active-custom-color-1 u-text-grey-40 u-text-hover-black 1page_login"  style="padding: 10px 20px;" href="#" onclick="javascript:alert('준비 중인 서비스 입니다!')">직업탐색</a>
				</li>
				<li class="u-nav-item">
            ...
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-sidenav-overflow">
                ...
                <ul  class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
					...
					<li class="u-nav-item">
                		<a class="u-button-style u-nav-link maker 1page_login"  style="padding: 10px 20px;"  href="#" onclick="javascript:alert('준비 중인 서비스 입니다!')">직업탐색</a>
					</li>
					<li class="u-nav-item">
