        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
          ...
          <div class="u-custom-menu u-nav-container">
           <ul class="u-custom-font u-nav u-unstyled u-nav-1">
            	<li class="u-nav-item">
            		<a class="u-button-style u-nav-link u-text-active-custom-color-1 u-text-grey-40 u-text-hover-black"  style="padding: 10px 20px;" href="<%=request.getContextPath()%>/portfolios">Portfolios</a>
				</li>
				<li class="u-nav-item">
            ...
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                	<li class="u-nav-item">
                		<a class="u-button-style u-nav-link maker"  style="padding: 10px 20px;"  href="<%=request.getContextPath()%>/portfolios">Portfolios</a>
					</li>
					<li class="u-nav-item">
      ...
      <div class="u-clearfix u-sheet u-valign-middle-lg u-sheet-1">
        ...
        <div class="u-blog u-expanded-width u-repeater u-repeater-1"><!--blog_post-->
          <div class="u-blog-post u-container-style u-repeater-item">
            <div class="u-container-layout u-similar-container u-valign-middle-sm u-valign-middle-xs u-valign-top-lg u-valign-top-md u-valign-top-xl u-container-layout-1"><!--blog_post_image-->
              <img src="<%=request.getContextPath()%>/resources/images/1.jpeg" alt="" class="u-blog-control u-expanded-width u-image u-image-round u-radius-21 u-image-1"><!--/blog_post_image--><!--blog_post_content-->
              <div class="u-blog-control u-post-content u-text u-text-1"><!--blog_post_content_content-->Sample small text. Lorem ipsum dolor sit amet.<!--/blog_post_content_content--></div><!--/blog_post_content--><!--blog_post_metadata-->
              <div class="u-blog-control u-metadata u-text-grey-40 u-metadata-1"><!--blog_post_metadata_date-->
                <span class="u-meta-date u-meta-icon"><!--blog_post_metadata_date_content-->Mon Feb 01 2021<!--/blog_post_metadata_date_content--></span><!--/blog_post_metadata_date-->
              </div><!--/blog_post_metadata-->
            </div>
          </div><!--/blog_post--><!--blog_post-->
          <div class="u-blog-post u-container-style u-repeater-item">
            <div class="u-container-layout u-similar-container u-valign-middle-sm u-valign-middle-xs u-valign-top-lg u-valign-top-md u-valign-top-xl u-container-layout-2"><!--blog_post_image-->
              <img src="<%=request.getContextPath()%>/resources/images/2.jpeg" alt="" class="u-blog-control u-expanded-width u-image u-image-round u-radius-21 u-image-2"><!--/blog_post_image--><!--blog_post_content-->
          ...
          <div class="u-blog-post u-container-style u-repeater-item">
            <div class="u-container-layout u-similar-container u-valign-middle-sm u-valign-middle-xs u-valign-top-lg u-valign-top-md u-valign-top-xl u-container-layout-3"><!--blog_post_image-->
              <img src="<%=request.getContextPath()%>/resources/images/3.jpeg" alt="" class="u-blog-control u-expanded-width u-image u-image-round u-radius-21 u-image-3"><!--/blog_post_image--><!--blog_post_content-->
          ...
          <div class="u-blog-post u-container-style u-repeater-item">
            <div class="u-container-layout u-similar-container u-valign-middle-sm u-valign-middle-xs u-valign-top-lg u-valign-top-md u-valign-top-xl u-container-layout-4"><!--blog_post_image-->
              <img src="<%=request.getContextPath()%>/resources/images/1.jpeg" alt="" class="u-blog-control u-expanded-width u-image u-image-round u-radius-21 u-image-4"><!--/blog_post_image--><!--blog_post_content-->
          ...
          <div class="u-blog-post u-container-style u-repeater-item">
            <div class="u-container-layout u-similar-container u-valign-middle-sm u-valign-middle-xs u-valign-top-lg u-valign-top-md u-valign-top-xl u-container-layout-5"><!--blog_post_image-->
              <img src="<%=request.getContextPath()%>/resources/images/2.jpeg" alt="" class="u-blog-control u-expanded-width u-image u-image-round u-radius-21 u-image-5"><!--/blog_post_image--><!--blog_post_content-->
          ...
          <div class="u-blog-post u-container-style u-repeater-item">
            <div class="u-container-layout u-similar-container u-valign-middle-sm u-valign-middle-xs u-valign-top-lg u-valign-top-md u-valign-top-xl u-container-layout-6"><!--blog_post_image-->
              <img src="<%=request.getContextPath()%>/resources/images/3.jpeg" alt="" class="u-blog-control u-expanded-width u-image u-image-round u-radius-21 u-image-6"><!--/blog_post_image--><!--blog_post_content-->
